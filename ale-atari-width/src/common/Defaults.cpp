...
/////////////////////////////////////////////////////////////////////////////////
    ...
    //new settings
    settings.setString("game", "Breakout-v0");
    settings.setFloat("ratio", 0.5);
    settings.setString("mode", "consensus");
    settings.setInt("cnn_action_repeat", 4);
    settings.setInt("search_frequency", 5);
    settings.setInt("cnn_num_input", 4);
   
    //video settings 
    settings.setBool("images", true);
